...
<div id="kirim-pesan" class="bg-white mt-lg-0 ms-lg-4 mt-3 h-100 text-dark" style="padding-top: 64px;">
    <div class="container-fluid col-lg-12 px-4 py-md-5 py-2 ">
        ...
        <div class="row g-5  col-lg-8 py-3">
            <form enctype="multipart/form-data" action="<?= base_url("data/pmks/tambah-spreadsheet"); ?>" method="post">
                <?= csrf_field(); ?>
                <?= getFlash('message'); ?>
                <h2>Form PMKS Menggunakan Spreadsheet</h2>
                <div class="row ">
                    <div class="col-md-12 mb-3 ">
                        <label for="file_excel">Upload File Excel</label>
                        <div class="input-group has-validation">
                            <input onchange="previewImage(this)" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" name="file_excel" type="file" id="file_excel" class="form-control <?= setInvalid('file_excel'); ?>" placeholder="Foto PMKS" aria-label="Foto PMKS">
