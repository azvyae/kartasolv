...
<div id="kirim-pesan" class="bg-white mt-lg-0 ms-lg-4 mt-3 h-100 text-dark" style="padding-top: 64px;">
    <div class="container-fluid col-lg-12 px-4 py-md-5 py-2 ">
        ...
        <div class="row g-5  col-lg-8 py-3">
            <form enctype="multipart/form-data" action="<?= base_url("data/psks/" . ($communityId ?? 'tambah')); ?>" method="post">
                <?= csrf_field(); ?>
                <?= getFlash('message'); ?>
                <h2>Identitas PSKS</h2>
                <div class="row ">
                ...
                <div class="row ">
                    <div class="col-md-6 mb-3">
                        <div class="form-floating has-validation">
                            ...
                            <select required name="psks_type" class="form-select <?= setInvalid('psks_type'); ?>" id="psks_type" aria-label="Jenis PSKS">
                                <option value="" selected>Pilih Salah Satu</option>
                                <?php foreach ($psksTypes as $p) : ?>
                                    <option <?= set_select('psks_type', $p->pmpsks_id, $pmpsksType === $p->pmpsks_id); ?> value="<?= $p->pmpsks_id; ?>"><?= $p->pmpsks_name; ?></option>
                                <?php endforeach ?>
                            </select>
                            <label for="psks_type">Jenis PSKS</label>
                            <div class="invalid-feedback">
                                <?= showInvalidFeedback('psks_type'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row ">
                    <!-- Modal -->
                    <div class="modal fade" id="foto_psks" tabindex="-1" aria-labelledby="foto_psks" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable modal-xl modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="foto_psks">Foto PSKS</h5>
                    ...
                    <div class="col-md-6 mb-3 ">
                        <label for="pmpsks_img_loc">Foto PSKS</label>
                        <div class="input-group has-validation">
                            <input onchange="previewImage(this)" accept="image/*" multiple="multiple" name="pmpsks_img_loc[]" type="file" id="pmpsks_img_loc" class="form-control <?= setInvalid('pmpsks_img_loc'); ?>" placeholder="Foto PSKS" aria-label="Foto PSKS">
                            <button type="button" class="btn btn-secondary input-group-text" data-bs-toggle="modal" data-bs-target="#foto_psks">
