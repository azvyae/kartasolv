                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="input-group has-validation">
                            <input onchange="previewImage(this)" name="image_a" type="file" id="image_a" class="form-control <?= setInvalid('image_a'); ?>" placeholder="Gambar Utama di Landing" aria-label="Gambar Utama di Landing">
